...
public abstract class ImageSegmentor {
  ...
  public void segmentFrame(Bitmap bitmap, int mode, Bitmap fgd, Bitmap bgd,int width, int height) {
    if (tflite == null) {
...
//      result=imageblend(fgd, bgd, Boolean.TRUE );
  ...
  public abstract Bitmap imageblend(Bitmap fg_bmp, Bitmap bg_bmp, Boolean harmonize,int width, int height);
  ...
  public abstract Bitmap videobokeh(Bitmap fg_bmp ,int width,int height);
